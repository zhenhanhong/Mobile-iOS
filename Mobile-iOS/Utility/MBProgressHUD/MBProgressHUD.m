...
#pragma mark - Modify by Steven.W 
// @ifOringinal 切换是否自定义，自定义 -> 1，原生 -> 0
#define ifOringinal 0
...
#pragma mark - Modify by Steven.W 2016.7.8
#if ifOringinal
    [self updateViewsForColor:self.contentColor];
#else
    [self updateViewsForColor:[UIColor whiteColor]];
#endif
...
//            _color = [[UIColor blackColor] colorWithAlphaComponent:.7f];
            _color = [UIColor colorWithWhite:0.95f alpha:0.6f];
        }
